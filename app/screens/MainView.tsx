    ...
    return (
        <SafeAreaView style = {globalStyles.anrdoidSafeArea}>
            <View style={styles.view}>
                ...
                <SeparatorLine text='Or enter the ID manually'/>
                <TextBox iconName='key-icon' placeHolder='Attendance ID' value={attendanceId} onChangeText={setAttendanceId}/>
                <QrGenerator value='213432'/>
            </View>
        </SafeAreaView>
    );
}
